...
function JsxUse() {
  ...
  //     {/* HTML에서는 input 또는 br 태그를 사용할 때 닫지 않고 사용 가능 하지만 
  //         리엑트에서는 태그를 열었으면 무조건 닫아야 함 */}
  //     <div></div>
  //     <input />
  //     <br />
  ...
  // const element = (
    ...
    // 이렇게 단순히 감싸기 위해서 불필요한 div를 감싸는게 별로 좋지 않을 때도 있음
    // HTMl 중첩 구조가 복잡해지며 그에 따른 스타일 설정을 할 때도 복잡해 질 수 있음
    // 이럴때 사용하는게 React의 Feagment
...
// export를 해줘야 다른곳에서 inport해서 사용 가능
